...
> = {
  RENT_HOUSING: { label: "Vivienda y Alquiler", emoji: "🏠", color: "bg-amber-500/10 text-amber-600 border-amber-200 dark:border-amber-800" },
  ACCOMMODATION: { label: "Alojamiento / Hospedaje", emoji: "🏨", color: "bg-purple-500/10 text-purple-600 border-purple-200 dark:border-purple-800" },
  LODGING: { label: "Villa / Alojamiento", emoji: "🏡", color: "bg-purple-500/10 text-purple-600 border-purple-200 dark:border-purple-800" },
  GROCERIES: { label: "Supermercado y Comida", emoji: "🛒", color: "bg-emerald-500/10 text-emerald-600 border-emerald-200 dark:border-emerald-800" },
  ...
  GAS_FUEL: { label: "Gasolina y Combustible", emoji: "⛽", color: "bg-blue-500/10 text-blue-600 border-blue-200 dark:border-blue-800" },
  ...
  INTERNET_TELECOM: { label: "Internet y Telefonía", emoji: "📶", color: "bg-teal-500/10 text-teal-600 border-teal-200 dark:border-teal-800" },
  HEALTH_MEDICAL: { label: "Salud y Farmacia", emoji: "💊", color: "bg-red-500/10 text-red-600 border-red-200 dark:border-red-800" },
  ENTERTAINMENT: { label: "Entretenimiento y Salidas", emoji: "🎉", color: "bg-indigo-500/10 text-indigo-600 border-indigo-200 dark:border-indigo-800" },
  SHOPPING: { label: "Compras y Ropa", emoji: "🛍️", color: "bg-fuchsia-500/10 text-fuchsia-600 border-fuchsia-200 dark:border-fuchsia-800" },
  ...
  TRIPS_TRAVEL: { label: "Viajes y Excursiones", emoji: "✈️", color: "bg-cyan-500/10 text-cyan-600 border-cyan-200 dark:border-cyan-800" },
